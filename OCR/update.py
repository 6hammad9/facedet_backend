...
def getEmbed(file):
    ...
    try:
        ...
        face = np.expand_dims(img, axis=0)   # (1, 3, 112, 112)
...
def generate_encodings_from_folder(folder_path="OCR/whitelisted", save_path="OCR/users.pkl"):
    users = {}
    ...
    with open(save_path, "wb") as f:
        pickle.dump(users, f)
    print(f"[INFO] Saved all encodings to {save_path}")
...
# Example use
users = load_or_generate_users("OCR/users.pkl", "OCR/whitelisted")
